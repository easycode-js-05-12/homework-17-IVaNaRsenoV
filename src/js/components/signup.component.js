...
export class SignupComponent {
    ...
    /**
     * @description - метод afterRender получает значения, необходимые для регистрации пользователя
     * @return {undefined} - undefined
     */

    afterRender() {
        document.forms['formSignup'].addEventListener('submit', (e) => {
            e.preventDefault();
            ...
            this._signupComponent.signup(userInfo)
                .then((response) => {
